...
export default function CustomerHomeScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-brand-bg">
      ...
      <View className="absolute bottom-6 left-6 right-6 h-16 bg-white rounded-full border border-gray-100 flex-row justify-around items-center px-4 shadow-lg shadow-black/5">
        {/* Tab 1: Home */}
        <TouchableOpacity
          onPress={() => setActiveTab("home")}
          className="items-center justify-center py-2 px-4 rounded-full flex-row gap-2"
          style={
            activeTab === "home"
        ...
        >
          <Ionicons
            name="home"
            size={20}
            color={activeTab === "home" ? "#F97316" : "#AAAAAA"}
          />
          {activeTab === "home" && (
        ...
        >
          <Ionicons
            ...
            size={20}
            color={activeTab === "track" ? "#F97316" : "#AAAAAA"}
          />
          {activeTab === "track" && (
            <Text className="font-bold text-xs" style={{ color: "#F97316" }}>
              Track
        ...
        >
          <Ionicons
            name="time-outline"
            size={20}
            color={activeTab === "history" ? "#F97316" : "#AAAAAA"}
          />
          {activeTab === "history" && (
            <Text className="font-bold text-xs" style={{ color: "#F97316" }}>
              History
        ...
        >
          <Ionicons
            name="person-outline"
            size={20}
            color={activeTab === "profile" ? "#F97316" : "#AAAAAA"}
          />
          {activeTab === "profile" && (
            <Text className="font-bold text-xs" style={{ color: "#F97316" }}>
              Profile
